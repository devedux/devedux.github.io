...
- **Top-p (nucleus sampling)** recorta por probabilidad acumulada: sumás de **mayor a menor** hasta juntar el umbral p. Con top-p=0.9: feliz (69%) + cansado (69+25=94%) ya supera 90%, corta ahí. Son los mismos 2 candidatos que top-k=2, pero es coincidencia de este ejemplo puntual.
